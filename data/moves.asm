...
MoveEnd:
	...
	move SMACK_DOWN,   NO_ADDITIONAL_EFFECT,        50, ROCK,     100, 15
	move FALSE_SWIPE,  FALSE_SWIPE_EFFECT,           1, NORMAL,   100, 40
	...
	move SNATCH,       DEFENSE_UP2_EFFECT,           0, DARK,     100, 10
	move ENDURE,       DEFENSE_UP2_EFFECT,           0, NORMAL,   100, 10
	move SAFEGUARD,    MIST_EFFECT,                  0, NORMAL,   100, 25
	move OVERHEAT,     NO_ADDITIONAL_EFFECT,       140, FIRE,      90, 5
	move LOW_SWEEP,    SPEED_DOWN_SIDE_EFFECT,      65, FIGHTING, 100, 20
	move SILVER_WIND,  ATTACK_UP_SIDE_EFFECT,       60, BUG,      100, 5
	move EMBARGO,      DEFENSE_DOWN1_EFFECT,         0, DARK,     100, 15
	move WILL_O_WISP,  BURN_EFFECT,                  0, FIRE,      85, 15
	move CHARGE_BEAM,  SPECIAL_UP_SIDE_EFFECT,      50, ELECTRIC,  90, 10
	move DRACO_METEOR, NO_ADDITIONAL_EFFECT,       140, DRAGON,    90, 5
